...
(function(ADL){
    ...
    {
        var conf = {};
        conf['endpoint'] = "https://cloud.scorm.com/tc/CJ0NK8AJKV/sandbox/";
        try
        {
            conf['auth'] = "Basic " + toBase64('jeffbatt@gmail.com:DevLearn17');
        }
        catch (e)
        {
    ...
    */
     ...
     * @return {object} xhr response object or null if 404
     * @example
     * var res = ADL.XAPIWrapper.getAgents({"":"mailto:tom@example.com"});
     * ADL.XAPIWrapper.log(res);
     * >> <Person object>
     */
